...
<table>                           
		...
		<?php
                ...
                $sql="select title,sendername,des from voice where recieveName='$username'";
          ...
          while($row=mysqli_fetch_row($result)){
                ...
                echo "<tr>
                         ...
                         "<td><audio src='".$destination."' controls='controls'>Your browser does not support the audio element.</audio></td>
                     </tr>";
                $i++;
            }
